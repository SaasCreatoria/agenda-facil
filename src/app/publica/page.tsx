...
export default function PaginaPublica() {
  ...
  const dynamicStyles = !isLoading && (configuracao.publicPagePrimaryColor || configuracao.publicPageAccentColor) ? `
    #public-booking-page-wrapper {
      ${configuracao.publicPagePrimaryColor ? `--primary: ${configuracao.publicPagePrimaryColor};` : ''}
      ${configuracao.publicPageAccentColor ? `--accent: ${configuracao.publicPageAccentColor};` : ''}
    }
  ` : '';
  ...
  return (
    <>
      ...
      <div id="public-booking-page-wrapper" className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-secondary/10 flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-2xl">
          <header className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-primary">{configuracao.publicPageTitle || 'Agende seu Horário'}</h1>
            <p className="text-lg text-muted-foreground mt-2">{configuracao.publicPageWelcomeMessage || 'Rápido, fácil e seguro.'}</p>
          </header>

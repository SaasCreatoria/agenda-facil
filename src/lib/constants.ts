...
// export const LS_AGENDAMENTOS_KEY = 'agendaFacilAgendamentos'; // No longer used, data in Firestore
// export const LS_SERVICOS_KEY = 'agendaFacilServicos'; // No longer used, data in Firestore
...
// export const LS_LEMBRETES_KEY = 'agendaFacilLembretes'; // No longer used, data in Firestore
